 ...
 */
public class AlarmFenster extends AppCompatActivity {
    /**
    ...
    private ActivityAlarmFensterBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityAlarmFensterBinding.inflate(getLayoutInflater());
    ...
    public void beendeAlarm(View view){
